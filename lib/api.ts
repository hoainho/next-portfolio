...
import { FETCH_POSTS_BY_QUERY, GET_POSTS_BY_AUTHOR_QUERY, GET_POSTS_BY_CATEGORY_AND_AUTHOR_QUERY, GET_POSTS_BY_TAGS_QUERY, POSTS_QUERY } from "@/graphql/queries/post.query";
