...
interface DroneModelProps extends GroupProps {
  isRotating: boolean;
}
...
interface ExtendedGLTF extends GLTF {
  nodes: {
    ...
    Sea_Sea_0: Mesh;
    Sky_Sky_0: Mesh;
    Drone_Body_body_0: Mesh;
    Drone_leg_F_leg_0: Mesh;
    F_P1_G_leg_0: Mesh;
    F_P2_leg_0: Mesh;
    F_P3_G_leg_0: Mesh;
    F_P4_leg_0: Mesh;
    ...
    F_P6_G_leg_0: Mesh;
    F_P7_leg_0: Mesh;
    Drone_Panel_R_body_0: Mesh;
    Drone_leg_R_leg_0: Mesh;
    R_P1_G_leg_0: Mesh;
    R_P2_leg_0: Mesh;
    R_P3_G_leg_0: Mesh;
    R_P4_leg_0: Mesh;
    ...
    R_P6_G_leg_0: Mesh;
    R_P7_leg_0: Mesh;
    Drone_Gen_L_body_0: Mesh;
    Drone_Panel_L_body_0: Mesh;
    Drone_leg_L_leg_0: Mesh;
    L_P1_G_leg_0: Mesh;
    L_P2_leg_0: Mesh;
    L_P3_G_leg_0: Mesh;
    L_P4_leg_0: Mesh;
    ...
    L_P6_G_leg_0: Mesh;
    L_P7_leg_0: Mesh;
    Drone_UPanel_R_body_0: Mesh;
    Drone_UPanel_L_body_0: Mesh;
    Drone_UPart_body_0: Mesh;
    Drone_ILens_body_0: Mesh;
    Drone_Turb_M_L_body_0: Mesh;
    Drone_Turb_Blade_L_body_0: Mesh;
    Drone_Turb_M_R_body_0: Mesh;
    Drone_Turb_Blade_R_body_0: Mesh;
    "0": Mesh; // if node name starts with a number, enclose it in quotes
    "1": Mesh; // if node name starts with a number, enclose it in quotes
  };
  materials: {
    Fortress: Material;
...
export function Drone({ isRotating, ...props }: DroneModelProps) {
  const { gl } = useThree();
  const ref =  useRef<Group>(null);
  // Load the 3D model and its animations
  const { animations, nodes, materials } = useGLTF('/3d/buster_drone.glb') as unknown as ExtendedGLTF;
  ...
  return (
    <group ref={ref} {...props} onClick={() => console.log("Hi there, please don't click me, let swipe screen")} dispose={null}>
